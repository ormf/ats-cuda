...
"
  ...
  (let ((name (if new-sound (string new-sound) 
    ...
    (set (read-from-string name)
	  ...
	  :time (copy-array (ats-sound-time sound))
	  :frq (copy-array (ats-sound-frq sound))
	  :amp (copy-array (ats-sound-amp sound)) 
	  :pha (if (ats-sound-pha sound) (copy-array (ats-sound-pha sound)) nil)
	  :energy (if (ats-sound-energy sound)(copy-array (ats-sound-energy sound)) nil)
	  :band-energy (if (ats-sound-band-energy sound)(copy-array (ats-sound-band-energy sound)) nil)))))
